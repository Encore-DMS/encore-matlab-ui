classdef Table < hgsetget
    ...
    methods
        ...
        function obj = Table(varargin)
            ...
            p.addParamValue('ColumnHeaderVisible','on');
    ...
    methods
        ...
        function set.BorderType(obj, value)
            switch lower(value)
                case {'line'}
                    border = javax.swing.BorderFactory.createLineBorder(java.awt.Color.gray);
                case {'none'}
        ...
        function v = get.ColumnHeaderVisible(obj)
            v = 'on';
            h = obj.JScrollPane.getColumnHeader();
            if ~isempty(h)
                if h.getVisible()
                    v = 'on';
                else
        ...
        function set.ColumnHeaderVisible(obj, v)
            h = obj.JScrollPane.getColumnHeader();
            if ~isempty(h)
                if strcmpi(v, 'on')
                    h.setVisible(true);
